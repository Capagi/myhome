...
<html lang="en">
  ...
  <head>
    ...
    <title>Imóveis online - fale conosco</title>
  ...
  <body>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="index.php"><h2>Fale<em>conosco</em></h2></a>
            ...
            <div class="contact-form">
              <form id="contact" action="" method="post">
                <div class="row">
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12">
                    <fieldset>
                      <input name="assunto" type="text" class="form-control" id="assunto" placeholder="Assunto em questão" required="">
                    </fieldset>
                  </div>
                  <div class="col-lg-12">
                    <fieldset>
                      <textarea name="mensagem" rows="6" class="form-control" id="mensagem" placeholder="Sua mensagem" required=""></textarea>
                    </fieldset>
                  </div>
                  <div class="col-lg-12">
                    <fieldset>
                      <button type="submit" id="submit_enviar" class="filled-button">Enviar mensagem</button>
                    </fieldset>
                  </div>
                </div>
              </form>
